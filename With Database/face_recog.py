...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(root,text="FACE RECOGNITION ",font=("poppins",40,"bold"),bg="black",fg="yellow")
        ...
        lbl = Label(title_lbl, font=('poppins',14, 'bold'), background='black', foreground ='white')
        lbl.place(x=5, y=10,width=120,height=40)
        time()

        
        img_11=Image.open("Images//17.png")
        ...
        b1_1=Button(root,text="Take Attendance",command=self.face_recogn,cursor="hand2",font=("poppins",30,"bold"),bg="yellow",fg="black")
    ...
    def face_recogn(self):
        def draw_boundary(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for(x,y,w,h) in features:
                ...
                conn=mysql.connector.connect(host="localhost",username="root",password="538810",database="face_recognizer")
