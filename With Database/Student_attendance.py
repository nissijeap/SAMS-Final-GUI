...
class Student_Attendance:
    def __init__(self,root):
        ...
        title_lbl=Label(root,text="ATTENDANCE REPORT",font=("poppins",40,"bold"),bg="black",fg="yellow")
        ...
        self.var_attend_course=StringVar()
        ...
        left_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Attendance Details",font=("poppins", 13, "bold"),bg="maroon", fg="yellow")
        ...
        IDno_label=Label(inside_left_frame, text="Attendance ID:",bg="white", font=("poppins",13, "bold"))
        IDno_label.grid(row=0,column=0, padx=10, pady=10, sticky=W)
    
        IDno_entry=ttk.Entry(inside_left_frame,textvariable=self.var_attend_id,width=20,font=("poppins",13, "bold"))
        ...
        self.atten_status["values"]=("Status", "Present", "Absent", "Late", "Excused")
        self.atten_status.grid(row=3,column=1, pady=8) 
        self.atten_status.current(0)
        
        #Course

        courseLabel=Label(inside_left_frame, text="Course:", bg="white", font="comicsansns 11 bold")
        courseLabel.grid(row=3,column=2)

        atten_course=ttk.Entry(inside_left_frame,width=22,textvariable=self.var_attend_course, font="comicsansns 11 bold")
        atten_course.grid(row=3,column=3, pady=8)
        ...
        import_button=Button(button_frame,text="Import Attendance csv",command=self.importcsv,width=60,font=("poppins",15,"bold"),bg="yellow",fg="black")
        import_button.grid(row=0,column=0)

        export_button=Button(button_frame,text="Export Attendance csv",command=self.exportcsv,width=60,font=("poppins",15,"bold"),bg="yellow",fg="black")
        export_button.grid(row=1,column=0)

        reset_button=Button(button_frame,text="Reset",command=self.reset_data,width=60,font=("poppins",15,"bold"),bg="yellow",fg="black")
        ...
        Right_frame=LabelFrame(main_frame, bd=2, relief=RIDGE, text="Attendance Details",  font=("poppins", 13, "bold"),bg="maroon", fg="yellow")
        ...
        self.AttendanceReport=ttk.Treeview(table_frame,column=("id","rollno","name","department","course","time","date","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.AttendanceReport.column("course", width=110)
   ...
   #*******Import csv************
    ...
    def get_cursor(self,arg=""):
        ...
        self.var_attend_course.set(rows[4])
        self.var_attend_time.set(rows[5])
        self.var_attend_date.set(rows[6])
        self.var_attend_attendance.set(rows[7])
