...
class About_Developer:
    def __init__(self,root):
        ...
        title_lbl=Label(root,text="ABOUT DEVELOPER",font=("poppins",40,"bold"),bg="maroon",fg="yellow")
        ...
        main_frame.place(x=790,y=254,width=735,height=700)


        dev_lbl=Label(main_frame,text="Third-year database students enrolled in BS in Information Technology at MSUIIT,",font=("poppins",12,"bold"),bg="light blue",fg="black")
        dev_lbl.place(x=0,y=170,width=730,height=50)

        dev1_lbl=Label(main_frame,text="pursuing a specialization in the field of databases. As developers,",font=("poppins",12,"bold"),bg="light blue",fg="black")
        dev1_lbl.place(x=0,y=220,width=730,height=50)

        dev1_lbl=Label(main_frame,text="they possess a strong interest and knowledge in designing, developing,",font=("poppins",12,"bold"),bg="light blue",fg="black")
        dev1_lbl.place(x=0,y=270,width=730,height=50)

        dev1_lbl=Label(main_frame,text=" and managing databases, which are crucial for organizing and storing data efficiently.",font=("poppins",12,"bold"),bg="light blue",fg="black")
        dev1_lbl.place(x=0,y=320,width=730,height=50)
